...
BorderSurface {
  ...
  // Live prototype: approximately 25% wider than the stock 380px card.
  implicitWidth: Style.space(475)
  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      Item {
        id: smallIconSlot
        Layout.preferredWidth: visible ? Style.space(44) : 0
        ...
        Text {
          ...
          font.pixelSize: Math.round(Style.font.displayLarge * 1.10)
        }
      }
      ...
      Text {
        ...
        color: Color.notifications.text
        font.family: root.fontFamily
        font.pixelSize: Math.round(Style.font.icon * 1.10)
      }
      ...
      ColumnLayout {
        ...
        Text {
          ...
          color: Color.notifications.text
          font.pixelSize: Math.round(Style.font.title * 1.10)
          font.bold: true
